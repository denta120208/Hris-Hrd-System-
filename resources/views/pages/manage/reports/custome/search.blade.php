        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form action="{{ route('hrd.search_emp') }}" method="post" class="form-inline">
                    ...
                    <div class="form-group">
                        <?php
                        $jobLevel = \App\Models\Employee\JobCategory::lists('name','id')->prepend('Divisi', '0');
                        ?>
                        {!! Form::label('job_level', 'Job Level', ['class'=>'sr-only']) !!}
                        {!! Form::select('job_level', $jobLevel, '', ['class' => 'form-control job_level', 'id' => 'job_level']) !!}
                    </div>
                    <div class="form-group">
                        <?php
                        $jobCategory = \App\Models\Employee\JobCategory::lists('name','id')->prepend('Divisi', '0');
