                    ...
                    <table class="table table-striped">
                        ...
                        @if($attends)
                            @foreach($attends as $attend)
                                <tr>
                                    <td>{{ date('l', strtotime($attend->tanggal)) }}</td>
                                    <td>{{ date('Y-m-d', strtotime($attend->tanggal)) }}</td>
                                    <td>{{ date('H:i:s', strtotime($attend->waktuIn)) }}</td>
                                    <td>{{ date('H:i:s', strtotime($attend->waktuOut)) }}</td>
                                </tr>
                            @endforeach
                        @else
                            <tr><td>No Data</td></tr>
