...
<style>
    .overlay {
        ...
        z-index: 1000;
        display: flex; /* Centering the overlay */
...
<script>
    $(document).ready(function() {
        ...
        // Check WebRTC and set IP
        setInterval(function() {
            if (checkCookiesEnabled()) {
                $("#overlayCookies").hide();
                setLatitudeLongitudeAndCheckCookies(); // Call the next function
            } else {
    ...
    function createOverlay(id, title, message) {
        ...
        $("#" + id).css("display", "flex"); // Show overlay without fade effect
    }
