            ...
            <div>
                <center>
                    <div>
                        ...
                        <div class ="judul2"><strong>No. 170/SK/METLAND/TGS/VII/23</strong></div><br><br>
                    ...
                    <div class="headeratas">
                        <table style="width: 100%" class="contentdata">
                            <tr>
                                ...
                                <td style="width: 84%; vertical-align: text-top;">
                                    <ol>
                                        <li>Adanya kebutuhan akan jabatan ….. di Metland Kertajati PT ……..</li>
                        ...
                        <table style="width: 100%" class="contentdata">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: text-top;">
                                    Terhitung tanggal <strong>......</strong> menugaskan <strong>Sdr. {{$fullName}}</strong> dengan jabatan <strong>…  (Junior …) Metland … – PT …  </strong> tanpa meninggalkan tugas dan tanggung jawabnya sebagai <strong>…. (Junior …) Metland … – PT …</strong>.
                                </td>
                            </tr>
                            <tr>
                                <td style="vertical-align: text-top;">
                                ...
                                <td style="vertical-align: text-top;">
                                    Pelaksanaan tugas berpedoman kepada Job Description dan peraturan yang berlaku di PT Metropolitan Land Tbk dan bertanggung jawab kepada ….. Metland …. PT …..
                                </td>
                            </tr>
                            <tr>
                                <td style="vertical-align: text-top;">
