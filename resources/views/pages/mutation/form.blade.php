        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <form action="{{ route('mutation.save') }}" method="POST">
                    ...
                    <?php
                    $job_level = \App\Models\Master\JobTitle::lists('job_level_title','id')->prepend('-=Title Name=-', '0');
                    ?>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <div class="nk-int-st">
                                {!! Form::label('mt_title_to', 'Title') !!}
                                {!! Form::select('mt_title_to', $job_level, '', ['class' => 'form-control', 'id' => 'mt_title_to']) !!}
                            </div>
                        </div>
                    </div>
