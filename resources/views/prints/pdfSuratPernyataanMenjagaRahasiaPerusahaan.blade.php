            ...
            <div>
                <center>
                    <div class ="header">
                        ...
                        <div><strong>Lampiran Form : F-HO&PROJECT/HRD-12</strong></div>
                    </div>
                    <div>
                        <br>
                        <br>
                    ...
                    <div class="headeratas">
                        <p>Sesuai dengan Perjanjian Kerja Waktu Tertentu No. .../KKWT/HRD/ML/../23, dan dimulainya hubungan kerja atas nama saya sebagai <strong>….. (Senior ….)</strong> terhitung sejak tanggal {{$empJoinDate}} dengan PT Sumber Selera Indonesia, maka dengan ini saya :</p>
                        <br>
                        ...
                        <ol>
                            <li>
                                Sebagai karyawan di PT ……, saya tidak akan memberikan data dan informasi perusahaan yang bersifat rahasia kepada pihak lain, dan tidak akan menggunakan data dan informasi perusahaan dalam bentuk apapun untuk kepentingan pribadi maupun pihak lain.
                            </li>
                            <li>
                            ...
                            <li>
                                Atas pernyataan saya tersebut di atas, saya tidak akan mengajukan tuntutan dalam bentuk apapun dikemudian hari kepada perusahaan.
                            </li>
