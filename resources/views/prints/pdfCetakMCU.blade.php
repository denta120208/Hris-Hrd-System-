       ...
       <div>
           <center>
                <div class="headeratas">
					...
					<p>Perihal Pengantar Test Kesehatan </p>
					
	            </div>
				<div class="headeratas2">
                    <p>Kepada Yth:</p>
					<p>Laboratorium {{$dataProject->Nama_Lab}}<br></p>
					<p>{{$dataProject->Alamat_Lab}}<br></p>
					<p>{{$dataProject->Kota_Lab}}<br></p>
                </div>
           </center>
        </div>
        <br><br>
		<div class="bodytengah1">
			...
			<p>Hari, tanggal : hari/tanggal {{$dataProject->hari_Tgl_mcu}}</p><br>
			<p>Waktu	  	 :	jam {{$dataProject->jam_mcu}} </p><br>
			<p>Paket Test 	: {{$dataProject->paket_mcu}} </p><br>
			<p>Lokasi Test	: {{$dataProject->Alamat_Lab}} {{$dataProject->Kota_Lab}}</p><br>
