    ...
    public static function menus(){
        ...
        if(Session::get('is_manage') == '1'){
            $query = DB::select(DB::raw("
                ...
                WHERE c.id IN (".$perms.") AND c.manage_status = '1'
                UNION ALL
                SELECT * FROM menus WHERE id IN (".$perms.") AND manage_status = '1';
            "));
        }else{
            $query = DB::select(DB::raw("
                SELECT DISTINCT p.* FROM menus as p INNER JOIN menus as c ON p.id = c.parent_id
...
//        if(Session::get('is_manage') != '1'){
//            $html_out .= '
//           <li><a href="#">Induction Trainning</a>
//
//            <li class="dropdown"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Induction<span class="caret"></span></a>
//                <ul class="dropdown-menu">
//                    <li><a href="Link Induction" id="link_induction">File Induction</a></li>
//                </ul>
//            </li>
//            ';
//        }
